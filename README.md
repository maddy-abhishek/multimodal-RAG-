 ...
 * LangChain – Core orchestration framewor
 * LangGraph – Agent workflow graph and state management
 * Google Flash 1.5 Pro – Primary LLM
 * HuggingFace Embedding Model – Sentence-transformer for embedding text
